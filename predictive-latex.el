...
(provide 'predictive-ams-latex-new)
...
(defvar predictive-ams-latex-debug-color "midnight blue")


(defun predictive-setup-ams-latex-new ()
  ...
  (add-to-list 'predictive-main-dict 'dict-ams-latex predictive-main-dict)
	...
	(auto-overlay-init
	 `(
	   ...
	   (line "%" (dict . predictive-main-dict) (priority . 4)
		 ...
		 (face . (background-color . ,predictive-ams-latex-debug-color)))
	   ...
	   (self "\\$" (dict . dict-ams-latex-math) (priority . 3)
		 ...
		 (face . (background-color
			  . ,predictive-ams-latex-debug-color)))
