;;; timerfunctions.el --- Enhanced timer functions.
;; Time-stamp: <2015-02-06 15:05:39 deego>
;; Copyright (C) Dave Goel 2000--2015.
...
;;; Commentary:
;; Run M-x timerfunctions-introduction and M-x timerfunctions-new-features.
...
(defun tf-time-difference (timeplus timesub)
  "Returns the time in seconds elaspsed from TIMESUB to TIMEPLUS.
...
(defun tf-run-with-idle-timer  (secs repeat redosecs redorepeat includeruntime function &rest args)
  "Run actions repeatedly while Emacs is idle.
